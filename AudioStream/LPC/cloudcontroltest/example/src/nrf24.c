...
bool SetupNRF(void)
{
	...
	Chip_IOCON_PinMux(LPC_IOCON, 5, 0, IOCON_FUNC0, IOCON_MODE_PULLUP);
	Chip_IOCON_PinMux(LPC_IOCON, 5, 1, IOCON_FUNC0, IOCON_MODE_PULLUP);
	Chip_IOCON_PinMux(LPC_IOCON, 5, 2, IOCON_FUNC0, IOCON_MODE_PULLUP);
